...
public class FirebaseRemoteConfig {
  ...
  private FirebaseRemoteConfig(FirebaseRemoteConfig.Builder builder) {
  ...
  static FirebaseRemoteConfig.Builder builder() {
    return new FirebaseRemoteConfig.Builder();
  }
  ...
  private CallableOperation<RemoteConfigTemplate, FirebaseRemoteConfigException> getOp() {
